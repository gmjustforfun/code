...
def selection_tournament_faster(self, tourn_size=20):
    '''
    Select the best individual among *tournsize* randomly chosen
    ...
    # print(aspirants_idx.shape) #100*20
    aspirants_values = self.FitV[aspirants_idx]
    # print(aspirants_values.shape) #100*20
...
def my_selection_tournament(self,tour_size=20):
    pass
